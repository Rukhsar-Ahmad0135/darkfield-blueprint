...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Wireless, stealth, surveillance, and core systems engineering for high-stakes environments." },
      { property: "og:title", content: "Dark Field Tech Labs" },
      { property: "og:description", content: "Engineering intelligent systems across wireless, stealth, surveillance, and core infrastructure." },
